        ...
        <div class="form-group mb-3">
          ...
          <div class="form-group">  
            ...
            <select id="list" name="list" class="form-control" multiple>
              <option value=""justisia institute">Justisia institute</option>
              <option value="justisia">Justisia</option>
            </select>
            <div id="hid">
            <input type="hidden" name="tags[]" value="poverty resource center"id="povertyresourcecenter">
            <input type="hidden" name="tags[]" value="prci" id="prci">
            </div>
